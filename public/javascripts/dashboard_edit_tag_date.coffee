...
addItem_click_callback = (button_id) ->
  $("#tag_Info").prepend "<div class='new_item'><span><input style='width:220px' class='new_item_tagBranch' type='text'></span><span><input style='width:125px' class='new_item_tagName' type='text'></span><span><input style='width:80px' class='new_item_ActiveFlag' type='text'></span><span><input style='width:150px' type='text' name='new_item_tagDate' value='' /></span></div>"
